...
public class ConnectToSqlDB {
    ...
    public List<String> readDataBase1 (String tableName, String columnName1, String columnName2)throws Exception{
        ...
        try {
            ...
            data = (List<String>) getResultSetData(resultSet, columnName1, columnName2);
    ...
    public void insertDataFromArrayListToSqlTable(List<String> list, String tableName, String columnName1, String columnName2)
